...
<!--                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>-->
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" min=0 class="form-control" id="InputEmailFirst" name="ph_num" placeholder="Phone Number" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputEmailSecond" name="address" placeholder="Address" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="date" class="form-control" id="InputEmailSecond" name="DOB" placeholder="DD-MM-YYYY" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputEmailSecond" name="sex" placeholder="Sex" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                    </div>
                </div>
                <div class="form-group">
